 ...
 * @version 2016.02.29
 */
public class StreamingEntry implements Comparable<StreamingEntry>
{
     ...
     */
    public StreamingEntry(String logline)
    {
     ...
     */
    public StreamingEntry(int year, int month, int day, int hour, int minute)
    {
        // The array to store the data for a single line.
        dataValues = new int[NUMBER_OF_FIELDS];
    ...
    public int getHour()
    {
        System.out.println("Extracted hour: " + dataValues[HOUR]);
     ...
     */
    public int compareTo(StreamingEntry otherEntry)
    {
